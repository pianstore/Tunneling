...
Exp=$(curl -sS https://raw.githubusercontent.com/Laksmana27/Tunneling/main/izin | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/Laksmana27/Tunneling/main/versions)
export pak=$( cat /home/.ver)
IPVPS=$(curl -s ipinfo.io/ip )
clear
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │                  ${BIWhite}${UWhite}Laksmana27${NC}"
echo -e "${BICyan} │"
