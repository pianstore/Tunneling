...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/pianstore/Tunneling/main/izin > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/pianstore/Tunneling/main/izin | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/pianstore/Tunneling/main/izin | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/pianstore/Tunneling/main/izin | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/pianstore/Tunneling/main/versions)
export pak=$( cat /home/.ver)
IPVPS=$(curl -s ipinfo.io/ip )
clear
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │                  ${BIWhite}${UWhite}Pian Store${NC}"
echo -e "${BICyan} │"
...
echo -e "${BICyan} │  ${BICyan}WHATSAP   :  ${BIYellow}0895472305081${NC}"
echo -e "${BICyan} │  ${BICyan}DEVELOVER :  ${BIYellow}RLP27${NC}"
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}" 
